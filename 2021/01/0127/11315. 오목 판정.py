...
sys.stdin = open('11315. 오목 판정.txt')
            ...
            if board[q][w] == 'o':
                ...
                for e in range(4):
                    ...
                    if e == 0:
                        ...
                        # 현재 위치에서 오른쪽으로 움직일 수 있는 범위가 5 이상인 경우에만 탐색 시작
                        # 5보다 작으면 탐색할 필요 없음
                        if n-w >= 5:
                    ...
                    # ↘ 방향이면
                        ...
                        # 현재 위치에서 오른쪽, 아래로 움직일 수 있는 범위가 5 이상인 경우에만 탐색 시작
                        if n-w >= 5 and n-q >= 5:
                            dfs(q,w,e,1)
                    ...
                    # ↓ 방향이면
                        ...
                        # 현재 위치에서 아래로 움직일 수 있는 범위가 5 이상인 경우에만 탐색 시작
                        if n-q >= 5:
                            dfs(q,w,e,1)
